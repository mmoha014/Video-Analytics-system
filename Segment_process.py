...
def Set_configuration(C, detection):
    ...
    return detection, targetSize, frame_rate
...
def Process_segment(segment, config, isprofiling, detection, video, groundtruth_box, targetSize):

    detection,targetSize,frame_rate = Set_configuration(config, detection)
